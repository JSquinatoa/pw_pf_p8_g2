<template>
  <div class="container_borrarcliente">
    ...
    <button class="boton_consulta borrar" @click="borrarCliente()">
      Borrar
    </button>
...
import { borrarPorIdFachada } from "@/clients/ClienteClient.js";
