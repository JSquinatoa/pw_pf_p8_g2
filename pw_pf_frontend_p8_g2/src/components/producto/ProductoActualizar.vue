...
.container_consultar_producto h1 {
    color: #003366; 
    margin-bottom: 25px; 
    font-size: 2.2em; 
    text-align: center;
...
@media screen and (max-width: 768px) {
    ...
    .mensaje-error-actualizar, .mensaje-exito-actualizar {
        padding: 8px 15px;
        font-size: 0.9em; 
    }
    .mensaje-error-actualizar h1, .mensaje-exito-actualizar h2 {
        font-size: 1.2em; 
    }
}
